...
cfg_if::cfg_if! {
    if #[cfg(feature = "unstable-wgpu-25")] {
        type DefaultSurface = wgpu_25_surface::WGPUSurface;
...
impl SkiaRenderer {
    ...
    #[cfg(feature = "unstable-wgpu-25")]
    /// Creates a new SkiaRenderer that will always use Skia's Vulkan renderer.
    pub fn default_wgpu_25(context: &SkiaSharedContext) -> Self {
        Self {
            maybe_window_adapter: Default::default(),
            rendering_notifier: Default::default(),
            image_cache: Default::default(),
            ...
            surface_factory: |context,
                              ...
                              size,
                              requested_graphics_api| {
                wgpu_25_surface::WGPUSurface::new(
                    context,
                    window_handle,
                    display_handle,
                    size,
